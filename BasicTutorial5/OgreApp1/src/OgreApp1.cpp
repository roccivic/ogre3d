...
//-------------------------------------------------------------------------------------
// OIS::KeyListener
bool BasicTutorial05::keyPressed( const OIS::KeyEvent& evt ){
    switch (evt.key)
    {
    case OIS::KC_ESCAPE: 
        mShutDown = true;
...
bool BasicTutorial05::keyReleased( const OIS::KeyEvent& evt ){
	switch (evt.key)
	{
	case OIS::KC_UP:
	case OIS::KC_W:
...
// OIS::MouseListener
bool BasicTutorial05::mouseMoved( const OIS::MouseEvent& evt ){
...
bool BasicTutorial05::mousePressed( const OIS::MouseEvent& evt, OIS::MouseButtonID id ){
